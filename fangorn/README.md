...
# set SEARCH_URL / CDN_URL / MCP_URL to the instance, and ADMIN_WALLETS to the
# wallets allowed to tear a namespace down
npx wrangler deploy
```

Then point the site at it with `VITE_QUICKBEAM_WORKER_URL`. Standing up the instance
itself is `quickbeam/DOCKER-README.md`.
